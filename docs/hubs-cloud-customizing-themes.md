...
You can add completely customized color schemes from the [Admin Panel](setup-configuring-content) by copying and pasting a theme JSON, like the example below:
