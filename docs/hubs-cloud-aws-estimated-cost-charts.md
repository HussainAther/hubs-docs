...
See our [Costs and Minimizing Costs Information](./hubs-cloud-aws-costs.html) page.
...
Read the [Recommended User Story in Minimizing Costs Page](./hubs-cloud-aws-costs.html#minimize-your-costs---a-user-story) first, to understand this calculation better.
...
- **Cost for EC2 (US\$/hr)** see below [estimate cost charts (alpha)](./hubs-cloud-aws-estimated-cost-charts.html#estimate-costs-charts-alpha)
- **SCALAR** _Roughly_ estimate costs of running other services like RDS, EFS, and Data transfer costs.
  ...
  - [To understand these states, read Recommended User Story in Minimizing Costs Page](./hubs-cloud-aws-costs.html#minimize-your-costs---a-user-story)
...
2. Off-time, I'm putting the instance in **offline** mode.
   ...
   - If you want the instance to be online, do [THE FORMULA](./hubs-cloud-aws-estimated-cost-charts.html#the-formula) calculation for a different instance size. Use x1.2 SCALAR for database pausing and x2 SCALAR for database pausing off.
...
**If you are diligent with decreasing the # of hours at top capacity**, outlined in the [minimizing costs user story](./hubs-cloud-aws-costs.html#minimize-your-costs---a-user-story), your event costs can be extremely low especially when comparing an in-person event:
...
- Read more about these settings in [minimizing costs user story](./hubs-cloud-aws-costs.html#minimize-your-costs---a-user-story)
...
**Note:** This does **not** exclude the **t3.small**, see what works for you. Scale the server type up or down ad hoc via [updating the stack](./hubs-cloud-aws-updating-the-stack.html).

**c4.large** is recommended for during an event.

**Note:** This does **not** exclude any other instances types, see what works for you. Scale the server type up or down ad hoc based on performance via [updating the stack](./hubs-cloud-aws-updating-the-stack.html).
...
Use the [Rough calculation section](./hubs-cloud-aws-estimated-cost-charts.html#rough-calculation-for-estimating-costs) to get estimates.

To see how vCPU to CCU Min/Max was estimated see [AWS Estimated CCU Limits](./hubs-cloud-aws-estimated-ccu-limits.html).

### Estimating Personal / Enterprise Costs with 1 server

[How to read and use Alpha Cost Charts](./hubs-cloud-aws-estimated-cost-charts.html#how-to-read-and-use-alpha-cost-charts)
...
2 app x 2 streaming servers recommended for best performance. [Why?](./hubs-cloud-aws-estimated-cost-charts.html#why-enterprise-2-app-x-2-stream)
