...
Room Permissions can be set on a room-by-room basis to allow more access to room visitors (to see how, see [Room Settings](hubs-room-settings).)
...
To change the default permissions of new rooms to be more permissive. First, open the [Admin Console](hubs-cloud-getting-started) then choose **App Settings**:
