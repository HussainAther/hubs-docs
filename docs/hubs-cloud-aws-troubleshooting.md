...
To get them running and take them "Online" follow the [Update the Stack Guide](./hubs-cloud-aws-updating-the-stack.html). When you want to take them "Offline" again, follow the same process and select "Offline".
